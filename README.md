...
| Роль | Потребность |
|-------|-------------|
| **Администратор** | Настройка списка отслеживаемых проектов |
| **Менеджер проекта** | Получение сводной статистики по задачам |
| **Руководитель** | Сравнение метрик нескольких проектов |
